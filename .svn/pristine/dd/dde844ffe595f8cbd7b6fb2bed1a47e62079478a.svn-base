...
<script lang='ts' setup name='addProductNumber'>
            ...
            itemStyle: {
                normal: {
                    color: {
                        ...
                        colorStops: [{
                            offset: 0,
                            color: 'rgba(25,119,229,0.5)' // 0% 处的颜色
                        }, {
                            offset: 1,
                            color: 'rgba(25,119,229,0.1)' // 100% 处的颜色
                        }]
                    }
                },
                // 设置强调（选中）样式
                emphasis: {
                    color: {
                        ...
                        colorStops: [{
                            offset: 0,
                            color: 'rgba(5,210,250,0.8)' // 0% 处的颜色
                        }, {
                            offset: 1,
                            color: 'rgba(5,210,250,0.1)' // 100% 处的颜色
                        }]
                    }
                },
...
watch(() => props.addProduct, (newVal, oldVal) => {
    if (newVal !== oldVal) {
        option.value.series[0].data = []
        option.value.xAxis.data = []
        props.addProduct.forEach((item: any, index: number) => {
